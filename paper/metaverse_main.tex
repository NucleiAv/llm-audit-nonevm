...
frontier models from OpenAI and Anthropic respectively; Llama-3.3-70B-Instruct
(served as \texttt{Llama-3.3-70B-Instruct-Turbo} via Together~AI) is a strong
open-weights baseline.
All three ran at temperature~0 for deterministic outputs, with a maximum output
